...
import { publishBooks, editPublishBooks, deletePublishBooks } from '../api/index'
...
export default {
  ...
  methods: {
    ...
    cancel(id) {
      let _this = this;
      deletePublishBooks({id:id}).then((res)=>{
         _this.getAllData();
          _this.msg = "删除成功!"
          _this.isShowWeakErr = true;                    
          setTimeout((e)=>{
